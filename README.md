...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/dark-tooth-ab1a#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dark-tooth-ab1a
```

A live public deployment of this template is available at [https://dark-tooth-ab1a.templates.workers.dev](https://dark-tooth-ab1a.templates.workers.dev)
